...
<h1>New Post</h1>
<form action="panel?action=commitAddPost" method="post">
<label for="title" class="button danger">Title:</label><input class="button big" type="text" name="title" style="width:80%"><br><br>
